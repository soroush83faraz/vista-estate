...
- 🎥 هیروی ویدیویی اسکرول‌اسکراب (سبک اپل): با اسکرول، دموی ۱۰ثانیه‌ای فریم‌به‌فریم جلو/عقب می‌رود — ویدیو all-intra انکود شده تا سیک روان باشد (`public/media/vista-demo.mp4`؛ با reduced-motion یا خطای شبکه، پوستر ثابت می‌ماند)
